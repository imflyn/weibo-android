...
public class LettersList implements Serializable
{
    private int                hasnext;     // 结束标志，1：拉取完毕，0：未完
    private int                totalsesscnt; // 总的会话个数
    private long               timestamp;   // 时间戳

    private ArrayList<Letters> info;
    ...
    public final ArrayList<Letters> getInfo()
    {
        return info;
    }

    public final void setInfo(ArrayList<Letters> info)
    {
        this.info = info;
    }
