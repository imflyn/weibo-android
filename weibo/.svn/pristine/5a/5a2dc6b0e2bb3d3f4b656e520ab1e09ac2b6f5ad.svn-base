    ...
    class BitmapDisplayer implements Runnable
    {
        ...
        public void run()
        {
            ...
            if (bitmap != null)
            {
                ...
                if (imageView instanceof TimeLineImageView)
                    ((TimeLineImageView) imageView).setImageBitmap(bitmap);
                if (imageView instanceof TimeLineAvatarImageView)
                    ((TimeLineAvatarImageView) imageView).setImageBitmap(bitmap);
                if (imageView instanceof WeiboDetailImageView)
                    ((WeiboDetailImageView) imageView).setImageBitmap(bitmap);
                mImageViews.remove(imageView);
            }
