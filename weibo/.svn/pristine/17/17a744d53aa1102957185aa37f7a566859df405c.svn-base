...
public class PullToRefreshListView extends ListView implements OnScrollListener
{
    ...
    private boolean          ifUpArrow          = true;
    private boolean          ifDownArrow        = true;
    ...
    private void changeHeaderViewByState()
    {
        switch (state)
        {
            ...
            case PULL_To_REFRESH:
                ...
                tipsTextview.setText(R.string.drop_dowm);
            ...
            case REFRESHING:
                ...
                break;
            case DONE:
                // System.out.println("完成DONE-TopPad："+(-1 *
                // headContentHeight));
                headView.setPadding(headView.getPaddingLeft(), -1 * headContentHeight, headView.getPaddingRight(), headView.getPaddingBottom());
                headView.invalidate();
    ...
    {
        View news_footer = activity.getLayoutInflater().inflate(R.layout.listview_footer, null);
        TextView news_footer_more = (TextView) news_footer.findViewById(R.id.listview_foot_more);
        ProgressBar news_footer_progress = (ProgressBar) news_footer.findViewById(R.id.listview_foot_progress);
        news_footer_more.setText(R.string.loading);
        news_footer_progress.setVisibility(View.VISIBLE);

    }

    public void hideFootView(Activity activity, String text)
    {
        View news_footer = activity.getLayoutInflater().inflate(R.layout.listview_footer, null);
        TextView news_footer_more = (TextView) news_footer.findViewById(R.id.listview_foot_more);
        ProgressBar news_footer_progress = (ProgressBar) news_footer.findViewById(R.id.listview_foot_progress);
    ...
    public final boolean isIfUpArrow()
    {
        return ifUpArrow;
    }

    public final void setIfUpArrow(boolean ifUpArrow)
    {
        this.ifUpArrow = ifUpArrow;
    }

    public final boolean isIfDownArrow()
    {
        return ifDownArrow;
    }

    public final void setIfDownArrow(boolean ifDownArrow)
    {
        this.ifDownArrow = ifDownArrow;
    }
