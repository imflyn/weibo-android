...
public class CommentNewsActivity extends AbstractWriteActivity
{
    ...
    public static Intent startBecauseSendFailed(Context context, String text, String reId)
    {
        ...
        intent.setAction(CommentNewsActivity.ACTION_SEND_FAILED);
    ...
    {
        Intent intent = new Intent(activity, CommentNewsActivity.class);
        intent.putExtra("text", text);
        intent.putExtra("reId", reId);
