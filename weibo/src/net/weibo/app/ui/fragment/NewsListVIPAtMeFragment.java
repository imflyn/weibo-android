...
public class NewsListVIPAtMeFragment extends AbstractAppFragment
{
    ...
    {
        return inflater.inflate(R.layout.fragment_vipnews, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        {
            newsList = (ArrayList<News>) savedInstanceState.getSerializable("vipNewsList");
        }
        initView();
    }
    ...
    private void initView()
    {
        ...
        pullToRefreshListView = (PullToRefreshListView) getActivity().findViewById(R.id.vipatme_pullToRefreshListView);
...
//                UIUtils.ToastMessage(getActivity().getApplicationContext(), "服务器不稳定,暂时无法加载最新评论!");
    ...
    public void onSaveInstanceState(Bundle outState)
    {
        ...
        outState.putSerializable("vipNewsList", newsList);
    }
