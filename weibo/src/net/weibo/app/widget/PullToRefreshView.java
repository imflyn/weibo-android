...
public class PullToRefreshView extends LinearLayout
{
    ...
    private void addFooterView()
    {
        ...
        LayoutParams params = new LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT, mFooterViewHeight);
        // int top = getHeight();
        // params.topMargin
     ...
     * @param bol
     */
    public void setIfUpArrow(boolean bol)
    {
        this.ifUpArrow = bol;
    }
     ...
     * @param bol
     */
    public void setIfDownArrow(boolean bol)
    {
        this.ifDownArrow = bol;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent e)
    {
        ...
        switch (e.getAction())
        {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!ifUpArrow && deltaY < 0)
                    break;
                if (!ifDownArrow && deltaY > 0)
                    break;
    ...
    public void onHeaderRefreshComplete()
    {
        ...
        mHeaderImageView.setImageResource(R.drawable.wb_refresh_arrow);
    ...
    public void onFooterRefreshComplete()
    {
        ...
        mFooterImageView.setImageResource(R.drawable.wb_refresh_arrow);
        mFooterTextView.setText("下拉刷新...");
        mHeaderUpdateTextView.setText("");
        mFooterState = PULL_TO_REFRESH;
    }
