...
public class PullDownListView extends FrameLayout implements GestureDetector.OnGestureListener, Animation.AnimationListener
{
    ...
    private class CheckForLongPress2 implements Runnable
    {
        ...
        {
            mLongPressing = true;
            MotionEvent e = MotionEvent.obtain(downEvent.getDownTime(), downEvent.getEventTime() + ViewConfiguration.getLongPressTimeout(), MotionEvent.ACTION_CANCEL, downEvent.getX(),
    ...
    private void addRefreshBar()
    {
        ...
        mArrow.setImageResource(R.drawable.wb_refresh_arrow);
        mUpdateContent.addView(mArrow);
        FrameLayout.LayoutParams layoutparams1 = new FrameLayout.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT, android.view.ViewGroup.LayoutParams.FILL_PARENT);
    ...
    public void onAnimationEnd(Animation animation)
    {
        ...
        if (top < 0)
            ...
            mArrow.setImageResource(R.drawable.wb_refresh_arrow_up);
        else
        {
            if (top < mLastTop)
            {
