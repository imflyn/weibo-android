package net.weibo.app.asynctask;
...
public abstract class MyAsyncTask<Params, Progress, Result>
{
    ...
    public static final Executor                 DOWNLOAD_THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(4, 20, KEEP_ALIVE, TimeUnit.SECONDS, sDownloadPoolWorkQueue, sDownloadThreadFactory,
